...
if (currentGameLevel == "Easy"){
 ...
 //Attempt to make all the sqaure have background color: rgb (200, 45,255) 
...
startButton.addEventListener("click", function () {
  ...
  // assign the header a random rgb value from one of the sqaure values.
...
setHeaderElementBackgroundColor(blueBackground, bElement);
 ...
 // add event listener to each square, so that it either disappear or changes every square's color
